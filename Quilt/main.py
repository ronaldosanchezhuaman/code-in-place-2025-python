...
def draw_circle_patch(canvas, start_x, start_y):
    ...
    canvas.create_oval(start_x-PATCH_SIZE, start_y+PATCH_SIZE,
        end_x-PATCH_SIZE, end_y+PATCH_SIZE, 'salmon')
...
def draw_square_patch(canvas, start_x, start_y):
    ...
    canvas.create_rectangle(start_x+PATCH_SIZE, start_y+PATCH_SIZE, 
    end_x+PATCH_SIZE, end_y+PATCH_SIZE, 'purple')
    # then draw a smaller white square on top
    canvas.create_rectangle(start_x+inset, start_y+inset, 
        end_x-inset, end_y-inset, 'white')
    
    canvas.create_rectangle(start_x+PATCH_SIZE+inset, start_y+PATCH_SIZE+inset,
    end_x+PATCH_SIZE-inset, end_y+PATCH_SIZE-inset, 'white')
